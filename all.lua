...
if text == "تفعيل تاك للكل" or text == "تعطيل تاك للكل" or text == "تفعيل تاك" or text == "تعطيل تاك" or text == "تفعيل all" or text == "تفعيل @all" or text == "تعطيل all" or text == "تعطيل @all" then                    
