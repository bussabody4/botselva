...
local j = json:decode(http.request("https://www.bot-sms.shop/api/yout/api.php?search="..URL.escape(search)..""))
...
local se = https.request("https://www.bot-sms.shop/api/yout/api.php?url="..URL.escape(text))
...
{
{text = 'ᴄʜ sᴏᴜʀᴄᴇ', url = "https://t.me/SO_SELVA"}
},
}
}
